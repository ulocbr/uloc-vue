...
export default {
  ...
  render (h) {
    return h('div',
      {
        'class': {
          'u-table-grid': this.grid,
          'u-table-container': true,
          'u-table-dark': this.dark,
          'u-table-dense': this.dense,
  ...
  methods: {
    ...
    getBody (h) {
      ...
      if (this.grid) {
        ...
        if (item !== void 0) {
          return [
            (hasHeader && h('div', { staticClass: 'u-table-middle scroll' }, [
              h('table', { staticClass: `u-table${this.dark ? ' u-table-dark' : ''}` }, [
      ...
      return h('div', { staticClass: 'u-table-middle scroll', 'class': this.tableClass, style: this.tableStyle }, [
        h('table', { staticClass: `u-table u-table-${this.separator}-separator${this.dark ? ' u-table-dark' : ''}` },
          [
