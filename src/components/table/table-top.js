  ...
  methods: {
    getTop (h) {
      const
        ...
        staticClass = 'u-table-top relative-position row items-center',
        child = []
      ...
      if (hasSelection) {
        ...
        if (topLeft) {
          ...
          child.push(
            h('div', { staticClass: 'u-table-control' }, [
              h('div', { staticClass: 'u-table-title' }, this.title)
            ])
          )
        }
      }
      ...
      if (topRight) {
        child.push(h('div', { staticClass: 'u-table-separator col' }))
        child.push(
          h('div', { staticClass: 'u-table-control' }, [
