...
import UOptionGroup from '../option-group/UOptionGroup.js'
...
export default {
        ...
        show: () => {
          ...
          if (this.prompt || this.options) {
            node = this.prompt
              ...
              : this.$refs.modal.$el.getElementsByClassName('u-option')
          ...
          node = this.$refs.modal.$el.getElementsByClassName('u-btn')
          if (node.length) {
  ...
  computed: {
    ...
    okLabel () {
      return this.ok === true
        ? this.$uloc.i18n.label.ok
        : this.ok
    },
    cancelLabel () {
      return this.cancel === true
        ? this.$uloc.i18n.label.cancel
        : this.cancel
    },
    buttonClass () {
    ...
    cancelProps () {
      return Object(this.cancel) === this.cancel
        ? Object.assign({
          color: this.color,
          label: this.$uloc.i18n.label.cancel,
          noRipple: true
        }, this.cancel)
