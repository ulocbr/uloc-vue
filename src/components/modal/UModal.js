...
export default {
  ...
  computed: {
    ...
    transitionProps () {
      if (this.position) {
        return { name: `u-modal-${this.position}` }
      }
      ...
      return { name: this.transition || 'u-modal' }
    },
    modalCss () {
      if (this.position) {
  ...
  methods: {
    ...
    __register (opening) {
      ...
      if (this.maximized) {
        ...
        document.body.classList[state.action]('u-maximized-modal')
      }
      else if (!this.minimized) {
        ...
        document.body.classList[state.action]('u-responsive-modal')
      }
    }
  },
  mounted () {
