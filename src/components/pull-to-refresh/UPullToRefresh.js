...
export default {
  ...
  computed: {
    message () {
      switch (this.state) {
        case 'pulled':
          return this.releaseMessage || this.$uloc.i18n.pullToRefresh.release
        case 'refreshing':
          return this.refreshMessage || this.$uloc.i18n.pullToRefresh.refresh
        case 'pull':
        default:
          return this.pullMessage || this.$uloc.i18n.pullToRefresh.pull
      }
    },
    style () {
      ...
      h('div', {
        ...
        h('div', {
          ...
          h(UIcon, {
            ...
            props: { name: this.$uloc.icon.pullToRefresh.arrow },
            directives: [{
              name: 'show',
          ...
          h(UIcon, {
            ...
            props: { name: this.refreshIcon || this.$uloc.icon.pullToRefresh.refresh },
            directives: [{
              name: 'show',
              value: this.state === 'refreshing'
            }]
