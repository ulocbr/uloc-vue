import UItem from './UItem.js'
import UItemMain from './UItemMain.js'
import UItemSide from './UItemSide.js'
...
export default {
  ...
  render (h) {
    ...
    push(child, h, UItemSide, this.$slots.left, replace, {
      icon: cfg.icon,
      color: cfg.leftColor,
      avatar: cfg.avatar,
      letter: cfg.letter,
    ...
    push(child, h, UItemMain, this.$slots.main, replace, {
      label: cfg.label,
    ...
    push(child, h, UItemSide, this.$slots.right, replace, {
      right: true,
      icon: cfg.rightIcon,
