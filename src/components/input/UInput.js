...
export default {
  ...
  computed: {
    ...
    keyboardToggle () {
      return this.$uloc.platform.is.mobile &&
        this.isNumber &&
    ...
    inputClasses () {
      ...
      this.autofilled && classes.push('u-input-autofill')
      return classes
    },
    length () {
  ...
  methods: {
    ...
    __getTextarea (h) {
      return h('div', {
        ...
        h('textarea', {
          ref: 'shadow',
          staticClass: 'col u-input-target u-input-shadow absolute-top',
        ...
        h('textarea', {
          ref: 'input',
          staticClass: 'col u-input-target u-input-area',
          attrs: Object.assign({}, this.$attrs, {
  ...
  render (h) {
    ...
    [].concat(this.$slots.before).concat([
      ...
      (!this.disable && this.isPassword && !this.noPassToggle && this.length && h(UIcon, {
        slot: 'after',
        staticClass: 'u-if-control',
        props: {
          name: this.$uloc.icon.input[this.showPass ? 'showPass' : 'hidePass'],
          type: 'material'
        },
        nativeOn: {
      ...
      (this.editable && this.keyboardToggle && h(UIcon, {
        slot: 'after',
        staticClass: 'u-if-control',
        props: {
          name: this.$uloc.icon.input[this.showNumber ? 'showNumber' : 'hideNumber'],
          type: 'material'
        },
        nativeOn: {
          mousedown: this.__clearTimer,
      ...
      (this.isClearable && h(UIcon, {
        slot: 'after',
        staticClass: 'u-if-control',
        props: {
          name: this.$uloc.icon.input[`clear${this.isInverted ? 'Inverted' : ''}`],
          type: 'material'
        },
        nativeOn: {
          mousedown: this.__clearTimer,
