...
function showRipple (evt, el, { stop, center }) {
  ...
  container.className = 'u-ripple-container'
  animNode.className = 'u-ripple-animation'
  ...
  animNode.classList.add('u-ripple-animation-enter')
  animNode.classList.add('u-ripple-animation-visible')
  css(animNode, cssTransform(`translate(${x}px, ${y}px) scale3d(0, 0, 0)`))

  setTimeout(() => {
    animNode.classList.remove('u-ripple-animation-enter')
    css(animNode, cssTransform(`translate(${x}px, ${y}px) scale3d(1, 1, 1)`))
    setTimeout(() => {
      animNode.classList.remove('u-ripple-animation-visible')
