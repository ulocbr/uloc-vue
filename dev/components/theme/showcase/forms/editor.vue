<template>
  <u-page padding>
    ...
    <p>
      <u-toggle v-model="readonly" label="Read only" class="m-r-sm" />
      <u-toggle v-model="disable" label="Disable" />
    </p>
    <u-editor
      v-model="model"
      :readonly="readonly"
