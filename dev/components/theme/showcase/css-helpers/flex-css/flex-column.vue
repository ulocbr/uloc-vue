  ...
  <u-page padding class="row justify-center">
    <div style="width: 800px; max-width: 90vw;">
      <div class="row justify-center">
        <u-alert
          color="warning"
          v-if="!$uloc.platform.is.desktop || $uloc.platform.within.iframe"
          inline
          class="m-b-lg"
        >
      ...
      <u-alert icon="warning" color="yellow" class="m-b-md">
      ...
      <u-alert icon="warning" color="yellow" style="margin-bottom: 32px">
        <p class="caption no-margin text-black">
