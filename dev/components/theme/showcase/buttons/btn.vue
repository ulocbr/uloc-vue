<template>
  <u-page padding class="docs-btn row justify-center">
    <div style="width: 500px; max-width: 90vw;">
      ...
      <p class="caption">
        Full width button (or use flex classes on parent)
      </p>
      ...
      <div class="mat" style="margin-top: 20px">
        <p class="caption">
          Button with no auto-caps (Material Theme only)
        </p>
        <u-btn color="primary" no-caps label="No caps" />

        <p class="caption">
          No ripple effect (Material Theme only)
        </p>
        <u-btn color="primary" no-ripple label="No Ripple Effect" />

        <p class="caption">
          Wait for ripple then trigger (Material Theme only)
        </p>
        <u-btn color="primary" wait-for-ripple label="Click me" @click="alert" />
      </div>

      <p class="caption">
        Button with timeout (keep pressing more than one second)
      </p>
      <u-btn
        :label="`Count ${count}`"
        @click="count++"
      ...
      <p class="caption">
        Button with deterministic progress
      </p>
