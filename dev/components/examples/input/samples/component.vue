...
<template>
  <div class="docs-input">
    <view-source src="https://github.com/ulocbr/uloc-vue/blob/master/dev/components/examples/input/samples/component.vue" />
    <h5 id="plugin">
      Component
    </h5>
    <p>
      Você pode utilizar o UInput como um component em seu projeto.
    </p>
