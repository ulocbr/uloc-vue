...
module.exports = function (chain) {
  ...
  chain.resolve.alias
    .merge({
      uloc: resolve(`src/index.js`),
      'uloc-vue': resolve(`src/index.js`),
      'uloc-src': resolve(`src`),
      'uloc-css': resolve(`src/assets/styl/app.styl`),
  ...
  if (loader) {
    ...
    if (loader === 'stylus-loader') {
      ...
      rule.use('style-resources-loader')
        ...
        .options({
          patterns: [
            resolve(`src/assets/styl/variables.styl`)
          ]
        })
    }
  }
